-- ============================================================
-- Bracket Challenge: atomic CFP field replacement
--
-- This is deliberately service-role-only. The Next route enforces
-- super-admin access before calling it through supabaseAdmin.
-- ============================================================
...
begin
  ...
  where game.competition_id = p_competition_id
    and (
      (game.source_a_seed is not null and game.source_a_game_id is null)
      or (game.source_b_seed is not null and game.source_b_game_id is null)
    );
