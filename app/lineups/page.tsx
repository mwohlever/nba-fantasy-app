...
export default async function LineupsPage() {
  ...
  const [
    ...
    supabaseAdmin
      .from("players")
      .select("id, name, position_group, is_active, is_playing_today, nba_player_id, headshot_url")
      .eq("is_active", true)
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Build lineups, track the live slate, and keep the board mobile-friendly.
                </p>
              </div>
