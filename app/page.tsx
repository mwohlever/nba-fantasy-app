  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(45,212,191,0.15),_transparent_32%),linear-gradient(180deg,#07111f_0%,#020617_100%)] text-white">
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-5 sm:px-6 sm:pt-8">
        ...
        <section className="mb-10 border-y border-slate-800 py-6">
          <div className="mb-4 sm:flex sm:items-end sm:justify-between sm:gap-6">
            <div>
              ...
              <h2 className="mt-1 text-xl font-black text-white sm:text-2xl">
                Different games. Same group.
              </h2>
            </div>
            <p className="mt-2 max-w-md text-sm text-slate-400 sm:mt-0 sm:text-right">
              Draft, pick, and compete together throughout the sports calendar.
            </p>
          </div>
          ...
          <div className="grid gap-x-6 sm:grid-cols-2 lg:grid-cols-5">
            {PLATFORM_GAMES.map((game) => (
              <div
                key={game.key}
                className="flex min-w-0 items-center gap-3 border-t border-slate-800/80 py-3 lg:block lg:border-t-0 lg:border-l lg:py-1 lg:pl-4 first:lg:border-l-0 first:lg:pl-0"
              >
                <Image
                  src={game.logo}
                  alt=""
                  width={36}
                  height={36}
                  className="h-9 w-9 shrink-0 rounded-full object-cover ring-1 ring-white/10 lg:mb-3"
                />
        ...
        <footer className="mt-10 border-t border-slate-800 pt-5 text-xs text-slate-500">
          Questions?{" "}
          <a
            href="mailto:mark.wohlever@gmail.com"
            className="font-semibold text-slate-300 transition hover:text-teal-300"
          >
            mark.wohlever@gmail.com
          </a>
        </footer>
      </div>
    </main>
