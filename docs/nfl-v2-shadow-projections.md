...
Phase C produces only global raw QB/RB/WR/TE stat-line projections. The active shadow version is `nfl-v2-o1-opportunity5-production8-coldstart-v2`; its O1 opportunity/production formula remains frozen, with an explicit early-season prior-season window-fill bridge. It does not modify Draft, Home, Scores, live scoring, standings, or pick-time behavior. D/ST and K have no NFL V2 rows.
