    ...
    <section className="overflow-hidden rounded-3xl border border-slate-800 bg-slate-950 shadow-sm">
      ...
      <div className="divide-y divide-slate-800">
        ...
        {rows.map((row) => {
          ...
          const showScorecard =
            scorecardVisibility === "show" ||
            (
              scorecardVisibility === "auto" &&
              row.playingRound !== null
            );
          ...
          return (
            <div key={row.player.id}>
              ...
              <article className="bg-slate-950">
                ...
                <div className="flex items-center justify-end gap-2 border-t border-slate-800 bg-slate-950 px-4 py-2">
                  <label className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      aria-label={`${row.player.name} scorecard display`}
                      className="rounded-lg border border-slate-700 bg-slate-900 px-2 py-1 text-xs font-semibold text-slate-200"
                    >
                      <option value="auto">
                        Auto
                      </option>
